...
\begin{figure}[ht]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=300pt]{frontend/Ping-Pong-4p.png}}
	\end{center}
...
\paragraph
\mbox{}\\
Angenommen die Schläger würden 1:1 um den Pixelabstand der Controller bewegt werden und das Spielfeld habe eine Höhe von 400 Pixeln.
...
\end{enumerate}
\newpage
\paragraph{Formatierung per CSS} 
...
\subsection{Anpassung des WallBuilders}
